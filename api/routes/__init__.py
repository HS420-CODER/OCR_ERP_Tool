...
- ocr_routes: OCR processing endpoints (including batch) [v1]
...
- ocr_v2: Multi-engine Arabic OCR microservice [v2]
"""
...
from .ocr_v2 import ocr_v2_bp

__all__ = ["ocr_bp", "vision_bp", "engines_bp", "config_bp", "ocr_v2_bp"]
